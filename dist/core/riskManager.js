...
exports.getExecutionNotes = getExecutionNotes;
exports.calculateRiskLevels = calculateRiskLevels;
// 🧠 Clasifica perfil según capital disponible
function getRiskProfile(capital) {
    if (capital <= 30)
        return 'rescate';
    if (capital <= 100)
        return 'cauto';
...
function shouldExecuteTrade(profile, signalStrength) {
    const thresholds = {
        rescate: 85,
        cauto: 75,
        activo: 65,
...
function getExecutionNotes(profile) {
    const notes = {
...
function calculateRiskLevels(entryPrice, side, slPercent, tpPercent) {
