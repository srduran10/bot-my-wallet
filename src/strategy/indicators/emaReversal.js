 ...
 */
export function getEMASignal(prices, fastPeriod = 9, slowPeriod = 21) {
  ...
  if (emaFastPrev < emaSlowPrev && emaFastCurrent > emaSlowCurrent) return 'bullish'
  if (emaFastPrev > emaSlowPrev && emaFastCurrent < emaSlowCurrent) return 'bearish'
